...
const HomeFeaturedCourseCard = props => {
    return (
        <div className="bg-white p-2 md:p-6 rounded-xl inline-block md:flex flex-col">
            ...
            <div className="flex justify-between items-end w-full flex-1">
                <div className="w-full">
                    ...
                    <div className="flex justify-between items-center w-full font-medium md:font-normal mt-1 md:mt-0">
                        ...
                        <div className="text-gray-400 text-xs md:text-base md:hidden ml-4">{props.data.studiesLevel.nodes[0].name}</div>
                    </div>
                </div>
