...
const Pagination = ({ totalRecords = null, pageLimit = 30, pageNeighbours = 0, onPageChanged, pageCurrent = 1 }) => {
    ...
    const pagesNeighbours = typeof pageNeighbours === 'number' ? Math.max(0, Math.min(pageNeighbours, 2)) : 0;
                            ...
                            {pages.map((page, index) => {
                                ...
                                return (
                                    <a
                                        href="#"
                                        className={`${
                                            currentPage === page ? 'text-white bg-custom-secondary' : 'text-gray-700 bg-white'
                                        } relative inline-flex items-center px-4 py-2 rounded-md  text-sm font-medium  hover:text-white hover:bg-custom-secondary`}
