            ...
            <div className="bg-white">
                <div className="container mx-auto px-4 py-5">
                    ...
                    <div className="px-4 py-5 md:w-2/3">
                        ...
                        <div>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. A atque eaque error exercitationem facere fugit, incidunt ipsam
                            iusto maiores natus placeat possimus quam reiciendis unde voluptatibus. Iste iure omnis quas?
                        </div>
                    </div>
                </div>
            </div>
