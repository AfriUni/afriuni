            ...
            <div className="container mx-auto md:px-48 px-6 pt-8 space-y-5">
                <div className="flex items-center space-x-5">
                    ...
                    <div className="space-y-2">
                        ...
                        <h1 className="text-black text-3xl font-semibold capitalize">{data?.name.toLowerCase()}</h1>
                    </div>
                </div>
                <div className="grid md:grid-cols-3 grid-cols-1 md:gap-10 gap-5">
                    ...
                    <div className="col-span-1 space-y-3 md:space-y-6">
                        <div className="flex space-x-3">
                            {' '}
                            <FontAwesomeIcon icon={faUniversity} className="w-5 h-5" /> <span>{data?.university_count} Universities</span>
                        </div>
                        <div className="flex space-x-3">
                            {' '}
                            <FontAwesomeIcon icon={faFileArchive} className="w-5 h-5" /> <span>{data?.children.nodes.length} Specialisations</span>
                        </div>
                        <div className="flex space-x-3">
                            {' '}
                            <FontAwesomeIcon icon={faBookOpen} className="w-5 h-5" /> <span>{data?.count} Courses</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="container mx-auto py-8">
                ...
                <div className={'pt-4 md:pt-8 pb-6 md:pb-18'}>
                    <div className="container mx-auto px-4">
                        <h3 className={`font-medium text-custom-primary_2 text-center mt-5 md:mb-10 text-2xl md:text-4xl`}>
