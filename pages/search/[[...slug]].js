        ...
        <div className="grid md:grid-cols-3 grid-cols-1 md:gap-6">
          ...
          <div className="md:col-span-2 space-y-6">
            <div>
              ...
              <div className="font-normal pl-1 md:hidden block">
                158 Computer Engineering Courses
              </div>
              ...
              <div className="flex items-center space-x-2 text-sm md:text-xs mt-2 md:mt-4">
                ...
                <span className="cursor-pointer bg-white border border-gray-400 py-1 px-3 rounded-full flex space-x-2">
                  ...
                  <FontAwesomeIcon icon={faTimes} className="w-2" />
                </span>
              </div>
            </div>
            ...
            <Pagination
              ...
              pageLimit={10}
              pageNeighbours={2}
              onPageChanged={(data) => console.log(data)}
              pageCurrent={3}
            />
          </div>
        </div>
