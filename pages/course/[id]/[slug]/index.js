                    ...
                    <div className="col-span-2">
                        <div className="bg-white border border-gray-200 md:p-4 py-4 px-4 md:mb-6 mb-4 md:space-y-5 space-y-3">
                            <div className="flex justify-between">
                                <div className="w-full">
                                    <h1 className="text-2xl md:text-3xl font-medium text-black">Computer Technology, BSc</h1>
                                    <div className="md:flex justify-between w-full">
                                        ...
                                        <div className="flex md:block items-center justify-between">
                                            <div className="flex items-center space-x-2 md:space-x-2 mt-3 md:mt-3 text-gray-600 md:text-base">
                                                <FontAwesomeIcon icon={faMapMarkerAlt} className="md:w-4 w-3" /> <span>Cairo,</span>
                                                <span className="text-custom-primary">Egypt</span>
                                            </div>
                                            <div className="flex-1 md:hidden text-right mt-3">Taught in English</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center md:space-x-8 w-full justify-between md:justify-start">
                                ...
                                <div className="md:flex-1 hidden text-right">Taught in English</div>
                            </div>
                            ...
                            <div className="grid md:grid-cols-4 grid-cols-2 items-center w-full text-sm md:text-base gap-6 md:pt-6 pt-3 md:grid-rows-1 grid-rows-2">
                                ...
                                <div className="bg-gray-100 flex flex-col gap-1 justify-center items-center text-center md:px-2 px-4 md:py-3 py-1 md:text-lg rounded-lg w-full h-full">
                                    ...
                                    <span className="font-medium md:text-xl flex flex-col">
                                        <span>Jan 2021</span> <span>Aug 2021</span>
                                    </span>
                                </div>
                                <div className="bg-gray-100 flex flex-col gap-1 justify-center items-center text-center md:px-2 px-4 md:py-3 py-1 md:text-lg rounded-lg w-full h-full">
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    ...
                                    <tr className="divide-x divide-gray-200">
                                        ...
                                        <td className="px-4 py-4">
                                            ...
                                            <ul className="list-outside ml-4 list-disc">
                                                <li>
                                                    Application deadline: <span className="font-medium">Jan 2021</span>
                                                </li>
                                                <li>
                                                    Applications start in: <span className="font-medium">Jan 2021</span>
                                                </li>
                                            </ul>
                                        </td>
                                    </tr>
                                    <tr className="divide-x divide-gray-200">
                                        ...
                                        <td className="px-4 py-4">
                                            <ul className="list-outside ml-4 list-disc">
                                                <li>
                                                    For Egyptian Students: <span className="font-medium">Fcfa 500,000</span>
                                                </li>
                                                <li>
                                                    For Foreign Students: <span className="font-medium">Fcfa 800,000</span>
                                                </li>
                                            </ul>
                                        </td>
                                    </tr>
                            ...
                            <Accordion className={styles.accordion_3 + ' md:space-y-6 space-y-4'} preExpanded={[1]}>
                                ...
                                >
                                        ...
                                        <AccordionItemButton className={styles.accordion_heading_3}>
                                            ...
                                            <div className="w-1/5 flex justify-end pr-6">
                                                <AccordionItemState>
                                                    {({ expanded }) =>
                                                        expanded ? (
                                                            <FontAwesomeIcon icon={faChevronDown} className="mt-2 w-4 h-4 text-base text-white" />
                                                        ) : (
                                                            <FontAwesomeIcon
                                                                icon={faChevronLeft}
                                    ...
                                    <AccordionItemPanel className="bg-white text-custom-body px-6 py-6 w-full border border-gray-200">
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam animi at aut consequuntur dolorem enim,
                                            esse eveniet facere, fugiat in minus nobis non nostrum quis quod similique suscipit tempora voluptate!
                                        </p>
                                    </AccordionItemPanel>
                                </AccordionItem>
                                <AccordionItem
                        ...
                        <div className="bg-white border border-gray-200 md:p-4 py-4 px-4 md:mb-6 mb-4">
                            ...
                            <div className="flex items-center md:space-x-8 justify-between font-normal mb-6 md:w-2/3">
                                <div>6600 Students</div>
                                <div>Private Institution</div>
                                <div className="text-custom-secondary">75 Courses</div>
                            </div>
